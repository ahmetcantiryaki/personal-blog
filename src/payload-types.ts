...
export interface User {
  ...
  name: string;
  /**
   * Only admins can change roles. Public sign-ups are always readers.
   */
  role: 'admin' | 'reader';
  updatedAt: string;
  createdAt: string;
...
export interface Post {
  ...
  title: string;
  /**
   * Per-locale URL slug. Auto-generated from the title if left blank.
   */
  slug: string;
  excerpt?: string | null;
  content?: {
  ...
  /**
   * Per-locale SEO overrides. Falls back to title/excerpt when empty.
   */
  seo?: {
  ...
  /**
   * Estimated minutes, computed from content on save.
   */
