...
const TAG_TITLES: Readonly<Record<string, { en: string; tr: string }>> = {
  ...
  'ai-regulation': { en: 'AI Regulation', tr: 'Yapay Zeka Regülasyonu' },
  ...
  'autonomous-vehicles': { en: 'Autonomous Vehicles', tr: 'Otonom Araçlar' },
  aws: { en: 'AWS', tr: 'AWS' },
  ...
  chatgpt: { en: 'ChatGPT', tr: 'ChatGPT' },
  'ci-cd': { en: 'CI/CD', tr: 'CI/CD' },
  claude: { en: 'Claude', tr: 'Claude' },
  ...
  'digital-health': { en: 'Digital Health', tr: 'Dijital Sağlık' },
  ...
  'email-marketing': { en: 'Email Marketing', tr: 'E-posta Pazarlama' },
  ...
  hardware: { en: 'Hardware', tr: 'Donanım' },
  htmx: { en: 'HTMX', tr: 'HTMX' },
  images: { en: 'Images', tr: 'Görseller' },
  'influencer-marketing': { en: 'Influencer Marketing', tr: 'Influencer Pazarlaması' },
  ...
  'on-device-ai': { en: 'On-Device AI', tr: 'Cihaz Üzerinde Yapay Zeka' },
  'open-source': { en: 'Open Source', tr: 'Açık Kaynak' },
  openai: { en: 'OpenAI', tr: 'OpenAI' },
  'paid-advertising': { en: 'Paid Advertising', tr: 'Ücretli Reklamcılık' },
  ...
  'smart-home': { en: 'Smart Home', tr: 'Akıllı Ev' },
  smartphones: { en: 'Smartphones', tr: 'Akıllı Telefonlar' },
