---
title: "Freelance Developer Mistakes to Avoid"
...
1. **Write a fixed deliverables list.** Name every screen, endpoint, and feature. Anything not on the list is out of scope by default.
2. **Define revision limits.** "Two rounds of revisions per deliverable" stops infinite feedback loops cold.
3. **Log every request against the list.** When a new ask arrives, point to the document and confirm it is new.
4. **Send a change order, not a favor.** "Happy to add that — it's about 6 hours, I'll send an updated quote." Say it every time.
